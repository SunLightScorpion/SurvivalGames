...
public class SurvivalGames extends JavaPlugin{
    ...
    public void onEnable() {
        ...
        Objects.requireNonNull(getCommand("l")).setExecutor(new CommandLobby());
        Objects.requireNonNull(getCommand("hub")).setExecutor(new CommandLobby());
        Objects.requireNonNull(getCommand("h")).setExecutor(new CommandLobby());
